...
if __name__ == "__main__":
    # * Multivariate Gaussian Classifiers (MVGs) with Tied Covariance and different PCA dimensions *

    # specify the name of the file which will contain the results inside output/
    filename = "4_model_selection/mvg_tc_pca_minDCF"
