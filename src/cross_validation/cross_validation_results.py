...
class CrossValidationResults(ClassifiersResults):
    ...
    def print(self, models_error_rates=False, models_min_DCFs=False, models_actual_DCFs=False, phase=None):
        return super().print(
            ...
            phase="Cross Validation" if phase is None else phase
        )
    ...
    def load(filename=__default_output_file_name):
        ...
        used by the CrossValidationResults.save() method
        :param filename: the relative path of the file, with respect to the /output folder, where
         the results are stored
        :return: an instance of CrossValidationResults containing the results in the specified file
        """
        ...
        for metric_name in CrossValidationResults.__all_metrics_names:
