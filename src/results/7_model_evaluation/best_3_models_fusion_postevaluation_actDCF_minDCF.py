...
def __compute_1_2_3_fusion_eval_results():
    ...
    # best model configurations over the evaluation set
    ...
    classifiers = [
        ...
        SvmClassifier(
            ...
            rebalancing_true_prior_probability=0.5,
            preprocessors=[PCA(6)]
        ),
        # [3]
...
if __name__ == "__main__":
    # * Post-evaluation results of the fusion of the best 3 calibrated models [1] + [2] + [3],
    #   using optimal configurations for the *evaluation set*:
    #   min DCF, actual DCF and error rate *
    filename = "7_model_evaluation/best_3_models_fusion_postevaluation_actDCF_minDCF"
