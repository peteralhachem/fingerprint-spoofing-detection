...
def __compute_and_save_results_to(_filename):
    ...
    pca_dimension = 8
    c = math.pow(10.0, -2)
    rebalancing_true_priors = [0.05, 1.0/11.0, 0.2, 0.5]
    ...
    classifiers = [
        ...
        for pi_T in rebalancing_true_priors
    ]
...
if __name__ == "__main__":
    # * SVM classifiers with 2D Polynomial kernel, with C=10^-2,
    #   with z-normalization preprocessing, PCA=8 and different training priors for
    #   class rebalancing *

    # specify the name of the file which will contain the results inside output/
    filename = "4_model_selection/poly_2_svm_znorm_PCA_8_rebalance_minDCF"
