...
if __name__ == "__main__":
    # * Bayes error plot of the best 3 models, for prior log odds in [-4, 4] *
    filename = "6_model_calibration/best_3_models_bayes_err_plot"

    # filename = __save_results_to(filename)  # you might run it just once
    __load_print_results_and_plot_bayes_error_plot_from(
        filename,
        save_to="best_3_models_bayes_err_plot.pdf"
    )
